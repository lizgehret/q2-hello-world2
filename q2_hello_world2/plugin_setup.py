...
from q2_hello_world2 import __version__
from q2_hello_world2._methods import duplicate_table

citations = Citations.load("citations.bib", package="q2_hello_world2")

plugin = Plugin(
    name="hello-world2",
    version=__version__,
    website="https://example.com",
    package="q2_hello_world2",
