...
```shell
CONDA_SUBDIR=osx-64 conda env create -n q2-hello-world-dev --file ./environment-files/q2-hello-world-qiime2-tiny-dev.yml
```
...
```shell
conda env create -n q2-hello-world-dev --file ./environment-files/q2-hello-world-qiime2-tiny-dev.yml
```
